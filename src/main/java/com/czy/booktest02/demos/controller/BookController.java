...
import com.czy.booktest02.demos.utils.Neo4jHelper;
...
public class BookController {
    ...
    public R getOneBook(@PathVariable("id") Integer id){
        JSONObject jsonObject = Neo4jHelper.execCql("math (m:Employee) return m.name", new String[]{});
        System.err.println("kkk:"+jsonObject);
